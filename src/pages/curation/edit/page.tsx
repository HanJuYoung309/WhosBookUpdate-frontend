...
export default function EditCuration() {
  ...
  // Mock existing curation data
  useEffect(() => {
    // In real app, would fetch curation data by id
    setTitle('마음을 치유하는 힐링 도서 10선');
    setDescription('일상에 지친 마음을 달래주는 따뜻한 책들을 소개합니다. 에세이부터 소설까지 다양한 장르의 힐링 도서를 만나보세요.');
    setTags('힐링, 에세이, 소설, 마음치유');
    setBooks([
      {
        id: '1',
        title: '미드나잇 라이브러리',
      ...
      },
      {
        ...
        publisher: '말글터',
        isbn: '9788901234567',
        description: '일상 속에서 만나는 언어들의 따뜻한 이야기',
  ...
  const mockBooks: Book[] = [
    {
      ...
      coverImage: 'https://readdy.ai/api/search-image?query=The%20One%20Thing%20business%20book%20cover%2C%20professional%20design%2C%20focus%20concept%2C%20success%20theme%2C%20clean%20layout%2C%20business%20book%20aesthetic&width=120&height=180&seq=book4&orientation=portrait'
    },
    {
      id: '5',
      title: '82년생 김지영',
      ...
      publisher: '민음사',
      isbn: '9788937473722',
      description: '한국 여성의 일상을 그린 현실적인 소설',
      coverImage: 'https://readdy.ai/api/search-image?query=Korean%20contemporary%20novel%20cover%2C%2082%EB%85%84%EC%83%9D%20%EA%B9%80%EC%A7%80%EC%98%81%2C%20minimalist%20design%2C%20social%20issues%2C%20feminine%20theme%2C%20modern%20literature&width=120&height=180&seq=book5&orientation=portrait'
    },
    {
      id: '6',
      title: '코스모스',
      ...
      publisher: '사이언스북스',
      isbn: '9788983711892',
      description: '우주와 과학에 대한 경이로움을 전하는 명저',
      coverImage: 'https://readdy.ai/api/search-image?query=Cosmos%20book%20cover%2C%20space%20theme%2C%20scientific%20illustration%2C%20dark%20blue%20with%20stars%2C%20classic%20science%20book%20design&width=120&height=180&seq=book6&orientation=portrait'
    }
  ];
  ...
  const handleDelete = () => {
    if (confirm('정말로 이 큐레이션을 삭제하시겠습니까?')) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">큐레이션 수정</h1>
          <p className="text-gray-600">큐레이션 내용을 수정하거나 삭제할 수 있습니다.</p>
        </div>
